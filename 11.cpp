...
public:
    ...
    void getdata()
    {
        cout << "In Enter the roll no and name:";
        cin >> roll >> name;
    }
    void putdata()
    {
        cout << "In The roll no and name:";
        cout << roll << " " << name;
    }
};
...
public:
    ...
    void search()
    {
        ...
        int flag = 0;
        int r;
        cout << "In Enter roll to be searched:";
        cin >> r;
        fp.open("stu.dat", ios::in);
        while(!fp.eof())
        {
    ...
    void update()
    {
        ...
        int flag = 0;
        int r;
        cout << "In Enter roll to be updated:";
        cin >> r;
    ...
    void delete1()
    {
        ...
        int flag = 0;
        fstream fp1;
        cout << "In Enter roll to be deleted:";
        int r;
        cin >> r;
        fp.open("stu.dat", ios::in);
